...
public class VoiceRecordingComments extends ArrayAdapter<VoiceRecordingObjects> {
    private Typeface mCustomFont;


    public VoiceRecordingComments(@NonNull Context context, int resource, @NonNull List<VoiceRecordingObjects> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (convertView == null)
            convertView = ((Activity) getContext()).getLayoutInflater().inflate(R.layout.alert_dialog_textview, parent, false);
